...
@interface XYAnimationView ()<CAAnimationDelegate>
{
...
+(void)showInView:(UIView *)view{
    ...
    XYAnimationView *loading = [[XYAnimationView alloc] initWithFrame:view.bounds];
    [view addSubview:loading];
    [loading start];
}

+(void)hideInView:(UIView *)view{
    for (XYAnimationView *loading in view.subviews) {
        if ([loading isKindOfClass:[XYAnimationView class]]) {
            [loading stop];
